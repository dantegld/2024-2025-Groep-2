        ...
        <br>
            ...
            <tr>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $methode_id = $row['programa_id'];
                    if ($row['active'] == 1) {
                        echo '<td><a href="programDeactiveren?id=' . $methode_id . '">Deactivate</a></td>';
                    } else {
                        echo '<td><a href="programActiveren?id=' . $methode_id . '">Activate</a></td>';
                    }
                    echo '<td>
                    <form method="post" action="klantloyaliteitsprogramma">
                ...
                if (isset($_POST['save'])) {
                    ...
                    $sql = "UPDATE tblLoyaliteits SET Aantal = ? WHERE programa_id = ?";
